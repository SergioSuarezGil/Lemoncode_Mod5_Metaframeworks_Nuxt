...
export const houses: House[] = [
  {
    ...
    reviews: [
      ...
      },
      {
        ...
        author: 'Miguel',
        date: '2021-03-22',
        comment: 'Son super amables y pudimos pasar un rato bueno en familia. Muy recomendado',
        rating: 5,
      },
    ],
  },
  {
    ...
    amenities: ['Barbacoa', 'WiFi', 'Jardín', 'Calefacción', 'Aire acondicionado'],
    reviews: [
      {
        id: 'r3',
        author: 'Laura',
  ...
  },
  {
    ...
    amenities: ['Vistas al campo', 'WiFi', 'Chimenea', 'Parking', 'Mascotas permitidas'],
    reviews: [
      {
        id: 'r4',
        author: 'Carlos',
  ...
  },
  {
    ...
    amenities: ['Piscina privada', 'WiFi', 'Aire acondicionado', 'Jardín', 'BBQ', 'Parking'],
    reviews: [
      {
        id: 'r6',
        author: 'Pedro',
  ...
  },
  {
    ...
    amenities: ['Vistas a la montaña', 'WiFi', 'Chimenea', 'Jardín', 'Parking', 'Senderismo'],
    reviews: [
      {
        id: 'r7',
        author: 'Sofia',
        date: '2021-05-10',
        comment: 'Las vistas son espectaculares. Un lugar mágico para desconectar.',
        rating: 5,
      },
      {
        id: 'r8',
    ...
    reviews: [
      {
        ...
        author: 'María',
        date: '2021-07-28',
        comment: 'Casa auténtica con mucho encanto. Ideal para conocer Asturias.',
        rating: 5,
      },
      {
        id: 'r10',
        author: 'Javier',
        date: '2021-08-15',
        comment: 'Muy buena ubicación entre montaña y playa. Volveremos sin duda.',
        rating: 4,
      },
    ],
  },
